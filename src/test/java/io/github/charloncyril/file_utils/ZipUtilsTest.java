...
public class ZipUtilsTest {
	...
	public void test_zipFile() {
		ZipUtils.zipFile(FileUtils.getFile(RESSOURCES_FOLDER_TEST_ZIP.toString(), "info.csv"),
				RESSOURCES_FOLDER_TEST_ZIP.toString() + "/info.zip");
		assertTrue(FileUtils.getFile(RESSOURCES_FOLDER_TEST_ZIP.toString(), "/info.zip").exists());
	}

	@Test
	public void test_unzipFile() {
		ZipUtils.unzipFile(RESSOURCES_FOLDER_TEST_ZIP.toString() + "/info.zip",
				FileUtils.getFile(RESSOURCES_FOLDER_TEST_ZIP.toString(), "info.csv"));
